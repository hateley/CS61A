...
def is_swap(score0, score1):
    ...
    score0_first_digit = score0//10
    score0_second_digit = score0 % 10
    score1_first_digit = score1//10
    score1_second_digit = score1 % 10
    return score0_first_digit  == score1_second_digit and score0_second_digit == score1_first_digit
    # END Question 4
...
def make_averaged(fn, num_samples=1000):
    ...
    def avg(*args):
        ...
        while count < num_samples:
            avg_sum = avg_sum + fn(*args)
            count = count + 1
        return avg_sum / num_samples
    return avg
    # END Question 6
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while rolls <= 10:
        avg_score = averaged_roll_dice(rolls, dice)
...
def final_strategy(score, opponent_score):
    ...
    2. set higher margin if not close to winning, and lower margin if close to winning
    3. get free bacon points if above margin and no deleterious swap
    4. roll less dice when close to winning, thus reducing the risk of rolling 1
    5. roll 4 dice if four-sided and 5 dice if six_sided, according to run_experiments
    """
    # BEGIN Question 10
    #starting roll:
    #swap strategy
